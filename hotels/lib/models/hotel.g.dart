...
ItemDetail _$ItemDetailFromJson(Map<String, dynamic> json) {
  return ItemDetail(
    ...
    name: json['name'] as String,
    poster: json['poster'] as String,
    address: ItemAdress.fromJson(json['address'] as Map<String, dynamic>),
    price: json['price'] as String,
    rating: json['rating'] as String,
    services: ItemServices.fromJson(json['services'] as Map<String, dynamic>),
...
ItemAdress _$ItemAdressFromJson(Map<String, dynamic> json) {
  return ItemAdress(
    ...
    coords: ItemCoords.fromJson(json['coords'] as Map<String, dynamic>),
  );
}
